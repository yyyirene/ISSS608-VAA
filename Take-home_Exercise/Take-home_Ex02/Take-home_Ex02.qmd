...
```{r}
#| code-fold: true
#| code-summary: "'Person → Work' connections on Sailor Shift’s second-layer works"
nodes_tbl <- nodes_tbl %>% mutate(index = row_number())
...
### **2.Who has she collaborated with and directly or indirectly influenced? & 3.How has she influenced collaborators of the broader Oceanus Folk community**
