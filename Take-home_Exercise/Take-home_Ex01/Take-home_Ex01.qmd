...
```{r}
#| code-fold: true
#| code-summary: "Code of Binning Numerical Variables"
S_data <- S_data %>%
  mutate(
...
-   Mapping Planning Area (PA) to Region:
    A reference table is manually constructed to assign each Planning Area to one of Singapore’s five broad Regions (e.g., North, East). This enables aggregation and comparison at the regional level.
...
```{r}
#| code-fold: true
#| code-summary: "Data preparation for Region"
...
```{r}
#| code-fold: true
#| code-summary: "Data preparation for Age"
...
```{r}
#| code-fold: true
#| code-summary: "Data preparation for desnsity"
...
```{r}
#| code-fold: true
#| code-summary: "Data preparation for Heatmap"
...
```{r}
#| code-fold: true
#| code-summary: "Population pyramid "
...
#| fig-height: 8
#| code-fold: true
#| code-summary: "Density Distributions Plot"
